Generate SKILL.md section for "@opentui/core" v0.5.4.
...
Use `skilld search "query" -p @opentui/core` as your primary research tool — search before manually reading files. Run `skilld search --guide -p @opentui/core` for full syntax.

| Resource | Path |
|----------|------|
| Docs | `/Users/syn/work/aicmd/.claude/skills/opentui-core-skilld/.skilld/docs/` |
| Package | `/Users/syn/work/aicmd/.claude/skills/opentui-core-skilld/.skilld/pkg/` |
| Types | `/Users/syn/work/aicmd/.claude/skills/opentui-core-skilld/.skilld/pkg/index.d.ts` — **read this file directly** to verify exports |
| Issues | `/Users/syn/work/aicmd/.claude/skills/opentui-core-skilld/.skilld/issues/` |
| Discussions | `/Users/syn/work/aicmd/.claude/skills/opentui-core-skilld/.skilld/discussions/` |
| Releases | `/Users/syn/work/aicmd/.claude/skills/opentui-core-skilld/.skilld/releases/` |
<external-docs>
**Documentation** (use Read tool to explore):
- `/Users/syn/work/aicmd/.claude/skills/opentui-core-skilld/.skilld/docs/` (3 .md files)
- `/Users/syn/work/aicmd/.claude/skills/opentui-core-skilld/.skilld/docs/src/benchmark/` (1 .md files)
- `/Users/syn/work/aicmd/.claude/skills/opentui-core-skilld/.skilld/docs/src/specs/` (1 .md files)
- `/Users/syn/work/aicmd/.claude/skills/opentui-core-skilld/.skilld/docs/src/testing/` (1 .md files)
- `/Users/syn/work/aicmd/.claude/skills/opentui-core-skilld/.skilld/issues/` (31 .md files)
- `/Users/syn/work/aicmd/.claude/skills/opentui-core-skilld/.skilld/pkg/` (1 .md files)
- `/Users/syn/work/aicmd/.claude/skills/opentui-core-skilld/.skilld/pkg-core/` (1 .md files)
- `/Users/syn/work/aicmd/.claude/skills/opentui-core-skilld/.skilld/releases/` (21 .md files)
</external-docs>
...
|-----------|------|:-----:|--------|
| Docs | [``](./.skilld/docs/) | 9/10 | Primary source — recommended patterns, configuration, idiomatic usage |
...
Skip: obvious API usage, installation steps, general TypeScript/programming patterns not specific to this package, anything a developer would naturally write without reading the docs. Every item must be specific to @opentui/core — reject general programming advice that applies to any project.

Search: `skilld search "recommended" -p @opentui/core`, `skilld search "avoid" -p @opentui/core`

## Format

<format-example note="Illustrative structure only — replace placeholder names with real @opentui/core APIs">
```
## Best Practices

- Use @opentui/core's built-in `createX()` helper over manual wiring — handles cleanup and edge cases automatically [source](./.skilld/docs/api.md#createx)
...
Write your final output to the file `/Users/syn/work/aicmd/.claude/skills/opentui-core-skilld/.skilld/_BEST_PRACTICES.md` using the Write tool. If Write is denied, output the content as plain text instead — do NOT retry or try alternative paths.

After writing, run `skilld validate /Users/syn/work/aicmd/.claude/skills/opentui-core-skilld/.skilld/_BEST_PRACTICES.md` and fix any warnings before finishing. If unavailable, use `npx -y skilld validate /Users/syn/work/aicmd/.claude/skills/opentui-core-skilld/.skilld/_BEST_PRACTICES.md`.
