...
| Docs | [``](./.skilld/docs/) | 4/10 | Only migration guides or upgrade pages |
...
Search: `skilld search "deprecated" -p @opentui/core`, `skilld search "breaking" -p @opentui/core`, `skilld search "v0.5" -p @opentui/core`, `skilld search "v0.4" -p @opentui/core`, `skilld search "v0.3" -p @opentui/core`, `skilld search "Features" -p @opentui/core`
...
Write your final output to the file `/Users/syn/work/aicmd/.claude/skills/opentui-core-skilld/.skilld/_API_CHANGES.md` using the Write tool. If Write is denied, output the content as plain text instead — do NOT retry or try alternative paths.

After writing, run `skilld validate /Users/syn/work/aicmd/.claude/skills/opentui-core-skilld/.skilld/_API_CHANGES.md` and fix any warnings before finishing. If unavailable, use `npx -y skilld validate /Users/syn/work/aicmd/.claude/skills/opentui-core-skilld/.skilld/_API_CHANGES.md`.
