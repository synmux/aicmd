Generate SKILL.md section for "cli-spinners" v3.4.0.
...
Use `skilld search "query" -p cli-spinners` as your primary research tool — search before manually reading files. Run `skilld search --guide -p cli-spinners` for full syntax.

| Resource | Path |
|----------|------|
| Docs | `/Users/syn/work/aicmd/.claude/skills/cli-spinners-skilld/.skilld/pkg/README.md` |
| Package | `/Users/syn/work/aicmd/.claude/skills/cli-spinners-skilld/.skilld/pkg/` |
| Issues | `/Users/syn/work/aicmd/.claude/skills/cli-spinners-skilld/.skilld/issues/` |
| Discussions | `/Users/syn/work/aicmd/.claude/skills/cli-spinners-skilld/.skilld/discussions/` |
| Releases | `/Users/syn/work/aicmd/.claude/skills/cli-spinners-skilld/.skilld/releases/` |
<external-docs>
**Documentation** (use Read tool to explore):
- `/Users/syn/work/aicmd/.claude/skills/cli-spinners-skilld/.skilld/issues/` (5 .md files)
- `/Users/syn/work/aicmd/.claude/skills/cli-spinners-skilld/.skilld/pkg/` (1 .md files)
- `/Users/syn/work/aicmd/.claude/skills/cli-spinners-skilld/.skilld/pkg-cli-spinners/` (1 .md files)
- `/Users/syn/work/aicmd/.claude/skills/cli-spinners-skilld/.skilld/releases/` (20 .md files)
</external-docs>
...
Skip: obvious API usage, installation steps, general TypeScript/programming patterns not specific to this package, anything a developer would naturally write without reading the docs. Every item must be specific to cli-spinners — reject general programming advice that applies to any project.

Search: `skilld search "recommended" -p cli-spinners`, `skilld search "avoid" -p cli-spinners`

## Format

<format-example note="Illustrative structure only — replace placeholder names with real cli-spinners APIs">
```
## Best Practices

- Use cli-spinners's built-in `createX()` helper over manual wiring — handles cleanup and edge cases automatically [source](./.skilld/docs/api.md#createx)
...
Write your final output to the file `/Users/syn/work/aicmd/.claude/skills/cli-spinners-skilld/.skilld/_BEST_PRACTICES.md` using the Write tool. If Write is denied, output the content as plain text instead — do NOT retry or try alternative paths.

After writing, run `skilld validate /Users/syn/work/aicmd/.claude/skills/cli-spinners-skilld/.skilld/_BEST_PRACTICES.md` and fix any warnings before finishing. If unavailable, use `npx -y skilld validate /Users/syn/work/aicmd/.claude/skills/cli-spinners-skilld/.skilld/_BEST_PRACTICES.md`.
